...
namespace VideoOnDemand.Data.Migrations
{
    public class DbInitializer
    {
        ...
        public static void Initialize(VODContext context)
        {
            ...
            {
                userId = context.Users.First(x => x.Email.Equals(email)).Id;
            }
            ...
            if (!userId.Equals(string.Empty))
            {
                ...
                {
                    var instrustors = new List<Instructor>
                    {
                        new Instructor
                        {
                            Name = "John Doe",
                    ...
                    context.Instructors.AddRange(instrustors);
                    context.SaveChanges();
                }
                ...
                if (!context.Modules.Any())
                {
                    var modules = new List<Module>
                    {
                        ...
                        new Module { CourseId = courseId2, Title = "Module 2" },
                        new Module { CourseId = courseId3, Title = "Module 3" }
                    };
